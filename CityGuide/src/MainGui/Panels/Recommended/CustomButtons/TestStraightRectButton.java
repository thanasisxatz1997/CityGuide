package MainGui.Panels.Recommended.CustomButtons;
...
public class TestStraightRectButton extends JButton{
    public String text;
    ...
    public TestStraightRectButton( int givenWidth,int givenHeight)
    {
        resized=false;
