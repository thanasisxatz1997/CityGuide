...
public class TipsDisplayPanel extends JPanel {
    ...
    private void Load()
    {
        ...
        textArea.setText("Free entrance\n" +
        ...
        textArea.setFont(customSmallFont);

        TipsTextDisplayPanel tipsTextDisplayPanel=new TipsTextDisplayPanel();


        textArea.setBackground(new Color(0,0,0,0f));
        JScrollPane scrollPane=new JScrollPane(tipsTextDisplayPanel);
        //scrollPane.setBackground(new Color(0,0,1,0f));

        //scrollPane.setForeground(new Color(0,0,1,0f));
        scrollPane.setPreferredSize(new Dimension(730,580));
        tipsTextDisplayPanel.add(textArea);
